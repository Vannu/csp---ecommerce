...
if ($_GET["order_date"] && $_GET["invoice_no"]) {
	...
	$pdf->Cell(190,10,"Cerveza Premium",0,1,"C");
	$pdf->setFont("Arial",null,12);

	$pdf->Cell(50,10,"Fecha",0,0);
	$pdf->Cell(50,10,": ".$_GET["order_date"],0,1);
	$pdf->Cell(50,10,"Nombre del Cliente",0,0);
