...
function pagination($con,$table,$pno,$n){
	...
	if ($last != 1) {
		if ($pageno > 1) {
			$previous = "";
			$previous = $pageno - 1;
			$pagination .= "<li class='page-item'><a class='page-link' href='".$previous."' style='color:#333;'> Atras </a></li>";
		}
		...
		if ($last > $pageno) {
			$next = $pageno + 1;
			$pagination .= "<li class='page-item'><a class='page-link' href='".$next."' style='color:#333;'> Siguiente </a></li></ul>";
		}
	}
//LIMIT 0,10
	//LIMIT 20,10
