	...
	private function pagination($con,$table,$pno,$n){
		...
		if ($last != 1) {
			if ($pageno > 1) {
				$previous = "";
				$previous = $pageno - 1;
				$pagination .= "<li class='page-item'><a class='page-link' pn='".$previous."' href='#' style='color:#333;'> Atras </a></li></li>";
			}
			...
			if ($last > $pageno) {
				$next = $pageno + 1;
				$pagination .= "<li class='page-item'><a class='page-link' pn='".$next."' href='#' style='color:#333;'> Siguiente </a></li></ul>";
			}
		}
	//LIMIT 0,10
		//LIMIT 20,10
