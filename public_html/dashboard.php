        ...
        <div class="content mt-3">
            ...
            <div class="col-sm-6 col-lg-6">
                <div class="card text-white bg-flat-color-1">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title text-white bg-flat-color-1 text-center">Nuevas Ordenes</h4>
                            <p class="card-text">Generar facturas y ordenes de compras</p>
                            <a href="new_order.php" class="btn btn-primary">Nueva orden</a>
                                    <!-- new_order.php -->
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-6 col-lg-6">
                <div class="card text-white bg-flat-color-2">
                    <div class="card">
                        <div class="card-body">
                        <h4 class="card-title text-white bg-flat-color-2 text-center">Marcas o Proveedores</h4>
                            <p class="card-text">Agregar y administrar Marcas o Proveedores</p>
                            <a href="#" data-toggle="modal" data-target="#form_brand" class="btn btn-primary">Agregar</a>
                            <a href="manage_brand.php" class="btn btn-primary">Administrar</a>
                        </div>
                    </div>
                </div>    
            </div>
            ...
            <div class="col-sm-6 col-lg-6">
                <div class="card text-white bg-flat-color-3">
                        ...
                        <div class="card">
							<div class="card-body">
                            <h4 class="card-title text-white bg-flat-color-3 text-center">Categorias</h4>
								<p class="card-text">Agregar y administrar Categorias</p>
								<a href="#" data-toggle="modal" data-target="#form_category" class="btn btn-primary">Agregar</a>
								<a href="manage_categories.php" class="btn btn-primary">Administrar</a>
							</div>
						</div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-lg-6">
                <div class="card text-white bg-flat-color-4">
                    <div class="card">
						<div class="card-body">
                        <h4 class="card-title text-white bg-flat-color-4 text-center">Productos</h4>
							<p class="card-text">Agregar y administrar Productos</p>
							<a href="#" data-toggle="modal" data-target="#form_products" class="btn btn-primary">Agregar</a>
							<a href="manage_product.php" class="btn btn-primary">Administrar</a>
						</div>
					</div>
                </div>
            </div>
