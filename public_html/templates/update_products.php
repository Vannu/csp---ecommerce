        ...
        <form id="update_product_form" onsubmit="return false">
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" name="update_product" id="update_product" placeholder="Nombre del producto" required>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="d_product" name="d_product" placeholder="Detalle del producto" required/>
          </div>
          <div class="form-group">
