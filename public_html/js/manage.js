$(document).ready(function(){
			...
			$.ajax({
				...
				success : function(data){
					if (data == "DEPENDENT_CATEGORY") {
						alert("Esta categoria depende de otra sub categoria");
	...
	$("#update_category_form").on("submit",function(){
		if ($("#update_category").val() == "") {
			...
			$("#cat_error").html("<span class='text-danger'>Ingrese el nombre de la categoria</span>");
		}else{
			$.ajax({
				url : DOMAIN+"/includes/process.php",
				method : "POST",
	...
	$("#update_brand_form").on("submit",function(){
		if ($("#update_brand").val() == "") {
			...
			$("#brand_error").html("<span class='text-danger'>Ingrese nombre del proveedor</span>");
		}else{
			$.ajax({
				url : DOMAIN+"/includes/process.php",
				method : "POST",
